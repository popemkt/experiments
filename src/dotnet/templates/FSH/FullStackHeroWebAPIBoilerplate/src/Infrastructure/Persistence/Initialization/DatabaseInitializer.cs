...
internal class DatabaseInitializer : IDatabaseInitializer
{
    ...
    public DatabaseInitializer(TenantDbContext tenantDbContext, IOptions<DatabaseSettings> dbSettings,
        IServiceProvider serviceProvider, ILogger<DatabaseInitializer> logger)
    {
