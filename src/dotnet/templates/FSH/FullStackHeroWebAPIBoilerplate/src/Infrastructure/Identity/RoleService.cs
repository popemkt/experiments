...
using FullStackHeroWebAPIBoilerplate.Application.Identity;
using FullStackHeroWebAPIBoilerplate.Application.Identity.Roles;
...
using FullStackHeroWebAPIBoilerplate.Shared.Multitenancy;
using Mapster;
...
internal class RoleService : IRoleService
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        foreach (var claim in currentClaims.Where(c => !request.Permissions.Any(p => p == c.Value)))
        {
            ...
            {
                throw new InternalServerException(_localizer["Update permissions failed."],
                    removeResult.GetErrors(_localizer));
            }
        }
    ...
    public async Task<string> DeleteAsync(string id)
    {
        ...
        {
            throw new ConflictException(string.Format(_localizer["Not allowed to delete {0} Role as it is being used."],
                role.Name));
        }
