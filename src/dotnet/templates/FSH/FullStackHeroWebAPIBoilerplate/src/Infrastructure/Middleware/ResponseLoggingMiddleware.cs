...
namespace FullStackHeroWebAPIBoilerplate.Infrastructure.Middleware;
    ...
    public async Task InvokeAsync(HttpContext httpContext, RequestDelegate next)
    {
        ...
        Log.ForContext("ResponseHeaders",
            ...
            .Information(
                ...
                httpContext.Request.Method, httpContext.Request.Path, string.IsNullOrEmpty(email) ? "Anonymous" : email,
