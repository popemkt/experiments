...
namespace FullStackHeroWebAPIBoilerplate.Application.Dashboard;
...
public class GetStatsRequestHandler : IRequestHandler<GetStatsRequest, StatsDto>
{
    ...
    public GetStatsRequestHandler(IUserService userService, IRoleService roleService, IReadRepository<Brand> brandRepo,
        IReadRepository<Product> productRepo, IStringLocalizer<GetStatsRequestHandler> localizer)
    {
