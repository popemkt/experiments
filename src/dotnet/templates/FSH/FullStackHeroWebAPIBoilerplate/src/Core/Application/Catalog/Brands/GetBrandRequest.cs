namespace FullStackHeroWebAPIBoilerplate.Application.Catalog.Brands;
...
public class GetBrandRequestHandler : IRequestHandler<GetBrandRequest, BrandDto>
{
    ...
    public GetBrandRequestHandler(IRepository<Brand> repository, IStringLocalizer<GetBrandRequestHandler> localizer) =>
